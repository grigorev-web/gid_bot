...
const gigachatConfig = require('../config');
...
class TokenService {
    ...
    async getAccessToken() {
        return new Promise((resolve, reject) => {
            ...
            const postData = `scope=${gigachatConfig.SCOPE}`;
            ...
            const options = {
                ...
                // SSL настройки
                rejectUnauthorized: gigachatConfig.SSL.REJECT_UNAUTHORIZED,
                requestCert: gigachatConfig.SSL.REQUEST_CERT,
                agent: gigachatConfig.SSL.AGENT
            };
                ...
                res.on('end', () => {
                    try {
                        ...
                        if (response.access_token) {
                            ...
                            this.tokenExpiry = Date.now() + gigachatConfig.TOKEN_LIFETIME;
